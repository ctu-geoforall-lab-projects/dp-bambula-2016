...
Do výměnného souboru je možné dle přání zákazníka vybrat libovolné kombinace datových skupin, viz, tabulka č. \ref{l_datove_skupiny}. \cite{dp_landa}
...
Datový soubor \textit{.vfk} se skládá ze čtyř základních částí, které budou samostatně popsány na následujících řádcích této kapitoly:

\begin{itemize}
 \item hlavička \texttt{\&H},
 \item datové bloky \texttt{\&B},
 \item datové řádky \texttt{\&D},
