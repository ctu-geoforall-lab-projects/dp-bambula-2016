...
od verze 2.2.0. Přehled provedených změn popisuje přiložený \uv{patch},
...
%%% ML: tato kapitola spise patri do priloh!!!, ale chapu, ze by se potom
%%% text prilis zkratil
\subsubsection{ApplyChanges}
%%% ML: prvni vetu preformulovat
%% upraveno
...
Přiložené CD obsahuje zdrojové kódy zásuvného modulu, text diplomové práce a \uv{patch} knihovny GDAL vytvořený oproti
verzi 2.2.0.
