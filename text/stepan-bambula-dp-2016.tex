...
pod licencí open-source. Toto se mu daří i~díky mnoha dobrovolníkům,
...
Pro Českou republiku je jedním z~nejdůležitějších ovladačů knihovny
...
zásuvný modul, jehož autory jsou dnes již absolventi oboru
...
zcela intuitivní a~pro běžného uživatele toto mnohdy představovalo
...
Aplikace ISKN Studio slouží pro převod dat VFK do do geodatabáze, se
...
\textbf{MGEO}\footnote{http://www.gisoft.cz/MGEO/MGEO}
a~\textbf{SPIDER}\footnote{http://www.gisoft.cz/SPIDER/SPIDER}. Může
...
Software Spirit VFK je vytvořený a~distribuovaný společností GEOREAL
...
v~souvisejících aplikačních nadstavbách \textbf{Spirit
  KN}\footnote{http://www.georeal.cz/cz/spirit-desktop/spirit-kn}
a~\textbf{Spirit Portál -
  KN}\footnote{http://www.georeal.cz/cz/spirit-server/portal-kn},
...
souboru. Níže je uvedena ukázka otevření souboru VFK. \cite{gdal_vfk}
