...
není umožněno. Stejně tak je zakázáno načítání souborů z adresáře a 
databáze SQLite.
...
Poté je uživateli zpřístupněna ikona, díky níž je možné přidávat cestu k
více VFK souborům. Počet takto načtených VFK souborů je omezen na pět.
...
práce a \uv{patch} knihovny GDAL vytvořený oproti verzi 2.2.0.
