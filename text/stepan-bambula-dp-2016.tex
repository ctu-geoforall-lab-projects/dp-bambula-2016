...
\begin{figure}[htb]
\centering
\includegraphics{images/ISKNStudio-aplikace.png}
...
\begin{figure}[htb]
\centering
\includegraphics[scale=1]{images/vfk2dwg-ukazka.png}
...
\begin{figure}[htb]
\centering
\includegraphics[scale=0.3]{images/topol-aplikace.png}
...
Driver si interně data při prvním čtení ukládá do databáze SQLite ve stejném adresáři, jako je umístěn VFK soubor. Při opětovném čtení driver používá pro čtení již vytvořenou databázi. Implicitní chování driveru může být ovlivněno zadáním proměnných prostředí. 
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.45]{images/grass_ukazka.png}
